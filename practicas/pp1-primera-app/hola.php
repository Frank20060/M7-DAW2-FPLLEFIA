...
<html>
	...
	<body>
		...
		<header style="display: flex; gap: 40px; align-items: center">
		...
		<main>
			<div style="display: flex; gap: 40px;">
				<div>
					<img src="imagenes/yo.jpg" alt="Una foto mia" style="width: 200px; border-radius: 150px;">
				...
				<div>
					...
					<p style="white-space: pre-line;"> <!-- el style es para que cuando le de al space me haga un salto de linea y no me lo ponga todo junto-->
						< ?php= es lo que se usa para abrir un bloque de codigo en php que se va ha ejecutar.
						...
						El cuarto llama a una funcion que ya estara creada y que muetestra la info del servidor.
		...
		<footer">
			<p>Frank Villar Redondo</p>
			<?php 
				
				echo date('d/m/Y');  //Lo se porque es parecido a javascript y es lo que hicimos una vez con carlos

			?>
		</footer>
		
		<?php 
		sayHello('me llamo Frank');
		?>	
	</body>
</html>